...
//		  WebDriverManager.firefoxdriver().setup();
		...
		enterText(Uname, "kirthi08@tekarch.com", "UserName");
		WebElement pwd = driver.findElement(By.xpath("//input[@id='password']"));
		pwd.clear();
		enterText(pwd, "Shanu@123", "Password");
...
//Thread.sleep(6000);
			...
			enterText(lastname, "Krishnamurthy", "lastname");
...
//driver.switchTo().frame(postIframe);
			...
			enterText(postBody, "Hello Everyone", "PostText");
...
//Uploading a File
			...
			enterText(choosefile, "/Users/kirthi/Documents/Teckarch Training/draganddrop.html", "choosefile");
...
//clickObj(choosefileoption, "choosefileoption");
			enterText(choosefileoption, "/Users/kirthi/Desktop/Sunflower-field-Fargo-North-Dakota.jpeg", "choosefileoption");
